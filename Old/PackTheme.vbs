...
Dim ConfigFileName, ThemeFolderName, OutputThemeName, OutputFileName, OutputFolderName
...
OutputFolderName = Fso.GetParentFolderName(OutputThemeName)
If Len(OutputFolderName) = 0 Then
  OutputFolderName = "."
End If
OutputFileName = Fso.GetFileName(OutputThemeName)
Set ConfigFile = Fso.OpenTextFile(ConfigFileName, 2, True) 'For Writing
ConfigFile.WriteLine ".OPTION EXPLICIT"
ConfigFile.WriteLine ".Set CabinetNameTemplate=" & OutputFileName
ConfigFile.WriteLine ".Set DiskDirectory1=" & OutputFolderName
