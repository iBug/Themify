...
Sub CreateDefaultConfig(ByVal ConfigFileName)
  ...
  DefaultConfig = "; " & ProgramName & " running at: " & C_Time & vbCrlf & vbCrLf & _
    ...
    "; Path to the generated theme pack (extension will be automatically appended)" & vbCrLf & _
