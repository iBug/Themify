...
Sub WriteDirectiveFile(ByVal FileName, ByRef FileNames)
  ...
  DirectiveFile.WriteLine ".Set MaxCabinetSize=2000000000"
  DirectiveFile.WriteLine ".Set MaxDiskFileCount=0"
  DirectiveFile.WriteLine ".Set MaxDiskSize=2000000000"
  DirectiveFile.WriteLine """" & I_ThemeFileName & """ """ & Fso.GetFileName(I_ThemeFileName) & """"
  DirectiveFile.Close
  WriteDirTree C_Source, 0, FileNames, Nothing, NewExtendableWriterControl()
End Sub
...
Sub WriteDirTree(ByVal DirPath, ByRef Count, ByRef FileNames, ByRef Handle, ByRef Control)
  Dim Dir, Item
  ...
  For Each Item In Dir.SubFolders
    WriteDirTree Fso.GetFolder(Item.Path), Count, FileNames, Handle, Control
  Next
End Sub
